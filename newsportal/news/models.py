...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        posts = News.objects.filter(creator=self)
        print(type(posts))
        for p in posts:
...
class News(models.Model):
    ...
    post_category = models.ManyToManyField(Category, through='NewsCategory')
...
class NewsCategory(models.Model):
    post_to_post = models.ForeignKey(News, on_delete=models.CASCADE)
...
class Comment(models.Model):
    comment_to_post = models.ForeignKey(News, on_delete=models.CASCADE)
